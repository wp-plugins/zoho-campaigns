...
function zc_designshower(idval, toggleBoolean) {
    ...
    var orginialFormVal = "<div style=\"background-color:#fff;border:solid 1px rgb(207, 207, 207);\" id=\"total_form_child_" + idval + "\">" +
        "<div style=\"background-color:rgb(228, 228, 228);font-family:arial;font-size:14px;color:#000000;padding:15px;border-bottom:solid 1px rgb(207, 207, 207);\" id=\"form_title_" + idval + "\" align=\"center\">Subscriber to our Newsletter</div>" +
