...
try {
    ...
    if($ageIndicator == 'new')  {
        $wpdb->query(
            'DELETE FROM wp_options WHERE option_name like "zc4wp_a_%";'
        );
?>
...
<?php
    ...
    foreach( $wpdb->get_results('SELECT option_name,option_value FROM wp_options WHERE option_name like "zc4wp_a_%";') as $key => $row) {
        ...
        if(is_numeric($temp) && $option_value != '' && (trim($option_value['simple_form']) != '' || trim($option_value['zoho_form']) != '') )   {
            $str = $str . $temp . ":";
        }
    }
        ...
        <div name="form_all" id="form_all_<?php echo $sno; ?>" style="display:none;">
                                                                                                ...
                                                                                                <div id="adder_title_div_<?php echo $sno; ?>" class="zcmt15">
                                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                <tr>
                                                                                                                        ...
                                                                                                                        <td align="left" valign="middle">
                                                                                                                                <input type="text" value="Subscriber to our Newsletter" onkeyup="zc_formLabelChanger(this);" onblur="zc_emptyCheck(this);" id="adder_title_textfield_<?php echo $sno; ?>" />
                                                                                                                        </td>
                                                                                                                        <td width="25"></td>
                                                                                                                </tr>
                                                                                                        </table>
                                                                                        ...
                                                                                        <div style="background-color:#fff;border:solid 1px rgb(207, 207, 207);width:350px;" id="total_form_child_<?php echo $sno; ?>">
                                                                                                ...
                                                                                                <div id="form_body_container_<?php echo $sno; ?>" style="background-color:#fff;">
                                                                                                        ...
                                                                                                        <div style=" padding:10px 15px; text-align:center; margin-bottom:10px;">
                                                                                                                <input type="button" class="button button-primary" style="box-shadow: none;background-color:#e07070;font-family:Arial; font-size:14px; color:#fff; border:solid 1px #e07070; border-radius:5px;" value="Subscribe Now" id="form_button_<?php echo $sno; ?>"/>
                                                                                                        </div>
                                                                                                </div>
                                                                                        </div>
                                                                                <?php
                ...
                <div name="zohoform" style="display:none;padding:30px;" id="zoho_form_div_<?php echo $sno; ?>">
                        ...
                        <div id="zcform_save_button_<?php echo $sno; ?>" class="zcbtncntr">
                                <br/>
                                <button onclick="return zc_editorContentChecker(this,'2','<?php echo $apiKeyVal; ?>','<?php echo $id; ?>');" class="zcnewbuttonWP" id="zcform_button_<?php echo $sno; ?>" style="box-shadow: none;margin-right:15px;">
                                    <span>Save Changes</span>
...
?>
                ...
                ?>
                        ...
                        if ( ($total_form != '' && trim($total_form['simple_form']) != '') || ($total_form != '' && trim( $total_form['zoho_form']) != '') ) {  
                            $saved_list_count++;
                        ?>
                            <script>
                            ...
                            <table width="99%" style="border: solid 1px #ddd;border-top:0px;" cellspacing="0" cellpadding="0" class="zcsfrmlsttbl zclstclr<?php echo $saved_list_count%2; ?>">
                                ...
                                if ( $total_form != '' && trim( $total_form['zoho_form']) != '') { ?>
                                <tr>
                                    <?php if ( trim($total_form['simple_form']) == '') { ?>
                                    <td height="30" width="20%" align="left" valign="center" rowspan="2">
                                        <?php echo $name; ?>
                                    </td>
                                    <?php } ?>
                                ...
                                <?php }
                            if(trim($total_form['simple_form']) == '' && trim($total_form['zoho_form']) != '') { ?>
                                <tr>
                                    <td colspan="4">
                                        <em>
                            ...
                            <?php } else if(trim($total_form['simple_form']) != '' && trim($total_form['zoho_form']) == '') { ?>
                                <tr>
                                    <td colspan="4">
                                        <em>
