...
try {
    ...
    {
        $xml = new SimpleXMLElement('<response uri="/api/getmailinglists" version="1"><code>404</code><status>Not Found</status><message>We couldn\'t find the resource you\'re looking for.Please recheck the documentation and try again.</message></response>');
    }
    else
    {
